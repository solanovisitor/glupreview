    ...
    var fram: Data = Data() {
        didSet {
            ...
            for i in 0 ... 15 {
                ...
                trend.append(Glucose(raw: raw, rawTemperature: temperature, temperatureAdjustment: temperatureAdjustment, id: id, date: date, hasError: hasError, dataQuality: Glucose.DataQuality(rawValue: Int(quality))))
            }
            ...
            for i in 0 ... 31 {
                ...
                history.append(Glucose(raw: raw, rawTemperature: temperature, temperatureAdjustment: temperatureAdjustment, id: id, date: date, hasError: hasError, dataQuality: Glucose.DataQuality(rawValue: Int(quality))))
            }
...
//    }
    ...
    func detailFRAM() {
        ...
        print("Sensor region: \(SensorRegion(rawValue: region)?.description ?? "unknown")\(region != 0 ? " (0x\(region.hex))" : "")")
        if maxLife > 0 {
